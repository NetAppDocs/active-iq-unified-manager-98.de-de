...
. Geben Sie einen Namen für den Berichtsplan ein, setzen Sie die Frequenz auf *wöchentlich*, und füllen Sie die anderen Berichtfelder aus, und klicken Sie dann auf das Häkchen (image:../media/blue-check.gif[""]Am Ende der Reihe.
+

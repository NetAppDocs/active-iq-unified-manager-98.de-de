...
. Speichern Sie die Ansicht mit einem bestimmten Namen, der angibt, was die Ansicht zeigt, z. B. „`Least Used Aggregate Capacity`“, und klicken Sie auf das Häkchen (image:../media/blue-check.gif[""]).

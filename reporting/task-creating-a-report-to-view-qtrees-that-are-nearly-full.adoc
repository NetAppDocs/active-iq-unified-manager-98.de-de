...
. Speichern Sie die Ansicht mit einem bestimmten Namen, der die Anzeige widerspiegelt, z. B. „`Qtrees enym ennahezu full`“, und klicken Sie auf das Häkchen (image:../media/blue-check.gif[""]).

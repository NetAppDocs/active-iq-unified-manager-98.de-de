...
* Red hat Enterprise Linux oder CentOS Version 7.x und 8.x, basierend auf einer x86_64-Architektur
...
* MySQL Community Edition Version 8.0.21 (aus dem MySQL-Repository). Stellen Sie sicher, dass Sie alle zuvor installierten Versionen von MySQL 5.7 entfernt haben. Das Installationsprogramm von Unified Manager wurde aufgrund eines Interoperabilitätsprobleme auf die Unterstützung von bis zu MySQL Community Edition 8.0 beschränkt. 21. Sie müssen * nicht* aktualisieren MySQL auf eine Version größer als 8.0.21.

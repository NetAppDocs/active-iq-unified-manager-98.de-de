...
[NOTE]
====
Das "WFA Pack for managing Clustered Data ONTAP" ist in WFA 5.1 enthalten, sodass es nicht mehr erforderlich ist, dieses Pack aus dem NetAppStorage Automation Store herunterzuladen und separat auf Ihrem WFA Server zu installieren, wie es in der Vergangenheit notwendig war.  https://community.netapp.com/["WFA Pack zum Management von ONTAP"^]

...
* *Aktionen*
+
Ermöglicht Ihnen, die Gruppe entsprechend Ihrer Rolle zu bearbeiten oder zu löschen. Sie müssen über die Rolle „Anwendungsadministrator“ oder „Speicheradministrator“ verfügen.

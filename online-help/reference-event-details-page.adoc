...
+
Siehe xref:concept-cluster-components-and-why-they-can-be-in-contention.adoc[Cluster-Komponenten und warum sie über Konflikte verfügen können] Für eine Beschreibung der hier angezeigten Komponenten.

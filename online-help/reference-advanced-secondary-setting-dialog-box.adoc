...
http://www.netapp.com/us/media/tr-3966.pdf["Technischer Bericht 3966 von NetApp: Leitfaden zur NetApp Datenkomprimierung und Deduplizierung sowie Implementierungsleitfaden (Clustered Data ONTAP)"]
